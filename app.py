...
# ==========================================================
# Chart Theme: Dark Matplotlib Theme
# ==========================================================
...
def get_data(ticker):
    ...
    # Note: 'earnings' is deprecated; we will calculate EPS manually.
    earnings = pd.DataFrame()  
    # Restrict historical data to last 10 years:
...
if ticker:
    try:
        ...
        # Fallback: if fewer than 10 years are available, use last 5 years.
        ...
        # Helper: Evaluate a metric year-by-year
        ...
        # Calculate EPS manually: Net Income / Shares Outstanding
        eps_vals = {}
        ...
        # ----- Metric 7: LT Debt ÷ Net Income (latest fiscal year only) -----
        try:
        ...
        # For demonstration, we use a static latest U.S. CPI value.
        cpi = 0.032  # 3.2%
        pricing_comment = f"Compare the company's pricing adjustments with a U.S. CPI of ~{cpi*100:.1f}%. [Source: U.S. Bureau of Labor Statistics]"
        summary.append(("Pricing Power vs. Inflation", "—", pricing_comment))

        # ----- Metric 9: Organized Labor (Commentary) -----
        labor_comment = ("Review the company's SEC 10-K and recent news for union contracts, strike risks, and labor disputes. "
        ...
        barriers_comment = (
            ...
            "- Patents and proprietary technology [Source: SEC 10-K]\n"
            "- Economies of scale and cost advantages [Source: HBR]\n"
            "- Well-established distribution channels [Source: WSJ]"
        )
        ...
        # ======================================================
        # MIDDLE SECTION: Charts & Tables (in Tabs)
        # ======================================================
        ...
        for metric, data in metric_data.items():
            with st.expander(f"{metric} Trend (Click to Expand)", expanded=False):
                ...
                # Ensure values are float or NaN
